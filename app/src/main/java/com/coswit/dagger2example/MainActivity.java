...
//        ActivityComponent component = app.getAppComponent().getActivityComponentBuilder()
//                .horsePower(200)
//                .engineCapacity(300)
//                .build();
//        component.inject(this);
        ...
        ActivityComponent component = app.getAppComponent().getActivityComponentFactory()
                .create(80, 190);
        component.inject(this);
